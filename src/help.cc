...
. ftr VBI CBI
.\}
.TH "MANAGEBACKUPS" "1" "March 2023" "managebackups 2.3" ""
.hy
.SH NAME
.PP
...
Note: This means that the mtime of such files (e.g.\ resolv.conf) in
that backup will show the mtime of the previous time the file was backed
up.
But it will allow the entire backup to be removed on the next run if
