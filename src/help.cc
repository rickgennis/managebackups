...
. ftr VBI CBI
.\}
.TH "MANAGEBACKUPS" "1" "March 2023" "managebackups 1.4.5" ""
.hy
.SH NAME
.PP
...
{FB} Compare two backups within a profile and show the size change of
each file.
Unlike \f[B]\[en]diff\f[R] the comparison can be with any other backup
in the set - specify \f[B]\[en]compare\f[R] twice, once to name each
backup.
