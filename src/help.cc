...
. ftr VBI CBI
.\}
.TH "MANAGEBACKUPS" "1" "March 2023" "managebackups 2.1f" ""
.hy
.SH NAME
.PP
...
given to the same backup (many to many).
.PP
...
Relative holds are specified as a number of days, week, months and/or
years.
