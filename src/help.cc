...
. ftr VBI CBI
.\}
.TH "MANAGEBACKUPS" "1" "March 2023" "managebackups 1.7.2d" ""
.hy
.SH NAME
.PP
...
errors.
.TP
\f[B]-t,\[en]tag\f[R] [\f[I]data\f[R]]
{FB} There are three uses of the tag directive:
.RS
\[bu] .RS 2
.IP "(1)" 4
tag a backup as it\[cq]s taken (e.g.\ \[lq]mb -p main -t snapshot\[rq])
.RE
\[bu] .RS 2
.IP "(2)" 4
tag a previously taken backup (e.g.\ \[lq]mb -p main -t
snapshot=/var/backup/main-2024-02-23\[rq])
.RE
\[bu] .RS 2
.IP "(3)" 4
display backups that match a tag (e.g.\ \[lq]mb -1 -t snapshot\[rq])
.RE
.RE
.PP
When tagging a previous backup (2) the full backup name isn\[cq]t
