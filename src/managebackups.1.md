...
**-b**, **--blocks**
: By default all size values are displayed in bytes (KB, MB, GB, etc). Use **--blocks** to instead display disk usage in terms of blocks, like the the 'du' command.
...
Example output from **managebackups -0**
    ...
    #firewall_faub  firewall-faub-20230125@11:20:02  11:20:07  00:00:05  2.6M (52.2M)  20 (20)     66%  [4 days, 2 hours -> 2 hours, 9 minutes]
    ...
    firewall_faub  firewall-faub-20230125@17:20:04  17:20:11  00:00:07  99K (5.5M)     22 (22)      47%  [4 days, 6 hours -> 22 minutes, 34 seconds]
